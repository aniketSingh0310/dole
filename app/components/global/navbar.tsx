    ...
    <>
          ...
          <div className="flex flex-row px-16 justify-between items-center">
            ...
            <div className="flex flex-col">
              <div className="flex justify-end gap-4 pb-2">
               ...
               <div className="flex gap-1 items-center"><Mail size={15}/><p className="text-sm">india@dolelogitics.com</p></div>
              ...
              <div className="flex items-center md:justify-center md:space-x-10">
                ...
                >
                  ...
                  <div
                    className="flex items-center gap-2 hover:brightness-110 hover:animate-pulse py-2 px-5  bg-[#e8792e] text-white  text-sm cursor-pointer"
      ...
      >
        ...
        >
          ...
          <div
                    className="flex items-center gap-2 hover:brightness-110 hover:animate-pulse py-2 px-5  bg-[#e8792e] text-white  text-sm cursor-pointer whitespace-nowrap"
                    onClick={() => window.open("/brochure.pdf", "_blank")}
                  >
                    Track Shipment
                  </div>
